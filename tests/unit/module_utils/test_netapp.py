...
from ansible_collections.netapp.ontap.tests.unit.modules.utils import AnsibleExitJson, AnsibleFailJson, ModuleTestCase, set_module_args
...
class NetappTest(ModuleTestCase):
    REQUIRED_PARAMS = {"api_username": "rw",
                       ...
                       "ssid": "1"}
    REQ_FUNC = 'ansible_collections.netapp.ontap.plugins.module_utils.netapp.request'
